/**
 * Ambient module declaration for @solomakers/shared.
 *
 * This mirrors the type exports from packages/shared so that `tsc --noEmit`
 * can resolve the module without pulling files outside api/src (rootDir).
 * At runtime, bundler / tsx resolves the real package via workspace linking.
 */
declare module "@solomakers/shared" {
  // ── leads.ts ───────────────────────────────────────────────────────
